...
/**
 * Created by rodrigovillalba on 7/10/18.
 */
public class ClientInfo {
    ...
    private static String getFullURL(HttpServletRequest request) {
        final StringBuffer fullUrlWithMethod = new StringBuffer(getMethod(request));
        fullUrlWithMethod.append(" - ");
        fullUrlWithMethod.append(request.getRequestURL());

        final String queryString = request.getQueryString();

        final String result = queryString == null ? fullUrlWithMethod.toString() : fullUrlWithMethod.append('?')
                .append(queryString)
                .toString();
