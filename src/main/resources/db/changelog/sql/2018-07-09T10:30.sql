...
-- Clean up ps_families schema
DROP TABLE IF EXISTS ps_families.family_socialeconomical_attribute;
DROP TABLE IF EXISTS ps_families.family_socialeconomical_attribute_active;

-- Clean up survey schema
